  ...
  async template(
    ...
    try {
      ...
      doc
        ...
        .fillColor(colors.black)
        .text(
          '*Үүнээс гадна, хэрэв 10 дах асуултад 1-ээс дээш оноо авсан бол "цаашид нэмэлт үнэлгээ, мэргэжлийн тусламж үйлчилгээ авах шаардлагатай".',
          marginX,
          doc.y,
          { align: 'justify' },
        )
      ...
      doc
        ...
        .fillColor(colors.black)
        .text(
          'Хэрэв та сорилын 10 дах асуулт буюу "Надад өөрийгөө гэмтээх тухай бодол төрч байсан" гэсэн асуултанд 1-ээс дээш оноо авсан бол  та өөрийн болон хүүхдийнхээ аюулгүй байдлыг хангах үүднээс, сэтгэл гутралын түвшнийг үл харгалзан, заавал мэргэжлийн тусламж, үйлчилгээ хугацаа алдалгүй аваарай.\n\nСорилын тусламжтай зөвхөн таны өнгөрсөн долоо хоногийн сэтгэл зүйн байдлыг үнэлж байгаа тул шаардлагатай тохиолдол бүрд дахин  бөглөөрэй.',
          marginX,
          doc.y + 45,
          { align: 'justify' },
        )

  ...
  async template(
    ...
    try {
      ...
      doc
        ...
        .text(
          'Санаа зовсон, стресстэй, түгшсэн, айсан, тайван бус байдлыг сэтгэл түгшилт гэсэн ойлголтод хамааруулж үздэг. Сэтгэл түгших нь стресст үзүүлж буй хэвийн хариу урвал юм. Гэхдээ сэтгэл түгшсэн байдал удаан хугацаанд үргэлжилж, хүний өдөр тутмын хэвийн үйл ажиллагаанд сөрөг нөлөө үзүүлж буй сэтгэл түгших эмгэг болно.\n\nСэтгэл түгших эмгэгийн үед: ',
          marginX,
          doc.y,
          {
            align: 'justify',
      ...
      doc
        ...
        .fillColor(colors.black)
        .text(
          'Судлаачид илүү ахмад настай хүмүүсийн дунд сэтгэл түгшилтийн байдлыг илрүүлэх босго оноо илүү өндөр байх ёстойг тэмдэглэсэн байдаг. Хэрэв та 60-аас дээш настай бол босго оноог 54/55 хүртэл өгсөж хэрэглэх нь илүү зохистой (Кари Кваал ба бусад, 2005).',
          {
            align: 'justify',
          },
        )

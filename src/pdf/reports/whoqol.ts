  ...
  async template(
    ...
    try {
      ...
      doc
        ...
        .text(
          'Амьдралын чанарыг үнэлэх асуумж нь Биеийн эрүүл мэнд, Сэтгэл зүйн байдал, Нийгмийн харилцаа, Хүрээлэн буй орчны нөлөөлөл гэсэн 4 домэйнээс бүрддэг. Тестийн дүнг тооцоолохдоо тухайн домэйн дотроо асуултуудын дунджийг бодож, дараа нь 0-100 эсвэл 4-20 онооны шкал руу хөрвүүлдэг. Таны үр дүн:',
          { align: 'justify' },
        )
        .moveDown(1);

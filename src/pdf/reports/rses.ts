  ...
  async template(
    ...
    try {
      ...
      doc
        .list(
          [
            ...
            'Өөртөө таалагдах байдал  - Хувь хүний өөрийгөө хүлээн зөвшөөрөх, өөрийн үнэ цэнээ эергээр тодорхойлох зэрэг өөр лүүгээ хандсан эерэг сэтгэл хөдлөлтэй холбоотой байдлыг энд хэмжинэ. Энэ бүлэгт тодорхой амжилт, гүйцэтгэлээс үл хамааран, хүн өөртөө “хүн” гэдэг үүднээс хэрхэн хандаж буй үндсэн суурь үнэлэмжийг хамааруулж авч үзнэ.',
          ],
          doc.x + 20,
          doc.y,
          {
      ...
      doc
        ...
        .fillColor(colors.black)
        .text(
          'Хувь хүний өөрийгөө үнэлэх, өөртөө итгэх байдлыг судалдаг олон төрлийн онол загвар, үнэлгээний аргууд байдаг. Социологич, сэтгэл судлаач Моррис Розенберг анх 1965 онд боловсруулсан, Розенбергын өөрийгөө үнэлэх үнэлэмжийг тодорхойлох тест гэдэг нэрээр алдартай энэхүү сорил нь олон улсад хамгийн түгээмэл хэрэглэгддэг, сайтар судлагдсан сорил бөгөөд энэ чиглэлд “алтан стандарт” гэж тооцогддог. RSES асуумж нь хүчин төгөлдөр оношилгооны хэрэгсэл болох нь олон улсад олон дахин батлагдсан. Тухайлбал тестийн урьдчилан таамаглах чадвар, дотоод тогтвортой байдал, найдвартай байдлын үзүүлэлт харьцангуй өндөр байдаг.',
          { align: 'justify' },
        )
        .moveDown(1);
      ...
      if (mindset) {
        ...
        const titleY = startY + imageHeight / 2 - 20;
      ...
      doc
        ...
        .fillColor(colors.black)
        .text(
          'Хувь хүний хэв шинж, зан төрхийн талаас авч үзвэл, дотогшоо чиглэсэн хэв шинжтэй (интроверт) хүмүүстэй харьцуулахад гадагшаа чиглэсэн (экстроверт) хэв шинжтэй хүмүүсийн дунд өөрийгөө үнэлэх үнэлэмж илүү өндөр тодорхойдогддог. Харин эсрэгээрээ өөрийгөө үнэлэх үнэлэмжийн оноо багатай хүмүүс илүүтэй сэтгэлийн тогтворгүй байдал (Невротизм) бүхий хэв шинжтэй байх магадлал харьцангуй өндөр байдаг байна.* ',
          { align: 'justify' },
        )
        .moveDown(1);
      doc
      ...
      doc
        ...
        .fillColor(colors.black)
        .text(
          'Эмч, сэтгэл засалч нар энэхүү тестийг эмчилгээний хүрээнд олон аргаар ашиглах боломжтой. Тухайлбал, тестийг эрт илрүүлэг эсвэл урьдчилан сэргийлэх аргаар хэрэглэж өрийгөө үнэлэх үнэлэмж багатай хүмүүсийн дунд сэтгэл гутрал, сэтгэл түгшил зэрэг сэтгэл зүйн асуудал, бэрхшээл бий эсэхийг илрүүлж болно.\n\nҮүнээс гадна, хувь хүний өөрийгөө үнэлэх үнэлэмжийг засаж, сайжруулахад чиглэсэн сэтгэл заслын тусламж үйлчилгээнд хэрэглэдэг. Мөн төрөл бүрийн сэтгэл болон сэтгэцийн эрүүл мэндийн асуудалтай хүмүүст тусламж үйлчилгээний үр дүн, үйл явцыг хянах арга байдлаар хэрэглэж болдог чухал ач холбогдолтой. RSES тестийн хувьд үнэлгээ хоорондын онооны зөрөө нь 3 болон түүнээс их оноотой үед мэдэгдэхүйц өөрчлөлт гарсан байна гэж үздэг.',
          { align: 'justify' },
        )
        .moveDown(1);
      ...
      doc
        ...
        .fillColor(colors.black)
        .text(
          'Зарим судалгаагаар өөрийгөө үнэлэх үнэлэмжийн дундаж оноо 22.62 (±5.8), өөрийн чадамжийн дундаж 12.01 (±2.82), өөртөө таалагдах байдлын дундаж 10.62 (±3.35), бүлэг хоорондын зөрүү 1.39 (±2.15) байсан байна (Синклэйр, 2010).\n\n* - Хэрвээ та өөрийн хувь хүний хэв шинжээ мэдэхийг хүсвэл цаашид “Үндсэн 5-н хувь хүний хэв шинжийн (Big 5) тест”-ийг бөглөхийг санал болгож байна.',
          { align: 'justify' },
        )
        .moveDown(1);
      footer(doc);
